...
public class GameScreen implements Screen {
    ...
    public void show() {
        ...
        PocktedArea.setSize(MyGdxGame.VirtualWidth/200,MyGdxGame.VirtualHeight/30);
        ...
        AnimaiteLabel1=new CleanLabel(2,LabelForPlayer1);
    ...
    public void render(float delta) {
        ...
        else  if(foulsystem.Checkallballsmovement()) //if all balls stopped moving
        {
        ...
        //
        if(Player.playeroneturn) //change player turn labels
        {
            // AnimaiteLabel1.Draw();
            LabelForPlayer1.draw(MyGdxGame.batch,0.5f);
          // AnimaiteLabel1=new CleanLabel(2,LabelForPlayer1);
           // AnimaiteLabel1.startCountdownFromNow();
          ...
          // AnimaiteLabel2=new CleanLabel(2,LabelForPlayer2);
           // AnimaiteLabel2.startCountdownFromNow();
        }
